package br.com.cwi.resetflix.response.diretor;
...
public class ConsultarDetalhesDiretorResponse {
    ...
    public ConsultarDetalhesDiretorResponse(Long id, String nome, List<FilmesResponse> filmesResponse) {
        this.id = id;
        this.nome = nome;
        this.filmes = filmesResponse;
    }
